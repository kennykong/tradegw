 ...
 * 发货通知返回对象
 * @author xilu.tong
 * @version $Id: SendGoodsResponse.java, v0.1 2015年11月27日 下午2:34:02 xilu.tong Exp $
 */
public class SendGoodsResponse extends BasePublicResponse {

    /** SID */
    private static final long serialVersionUID = 7249640053310426642L;
    ...
    public SendGoodsResponse(TradegwResultCode resultCode) {
        this.setIs_success('0');
        this.setError_code(resultCode.getCode());
        this.setError_msg(resultCode.getMsg());
    }

    public SendGoodsResponse(String code, String msg) {
        this.setIs_success('0');
